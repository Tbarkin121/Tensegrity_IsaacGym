...
# load ball asset
asset_root = "../../assets"
asset_file = "mjcf/tensegrity.xml"
...
num_actors = gym.get_actor_count(envs[0])
body_dict = gym.get_actor_rigid_body_dict(envs[0], handles[0])
joint_dict = gym.get_actor_joint_dict(envs[0], handles[0])
...
for j in joint_dict:
    print(j)
    print(gym.get_asset_joint_type(asset, joint_dict[j]))
